<template>
  <div class="flex items-center h-screen py-8 px-8 bg-gradient-to-r from-backgroundGradient to-white">
    <div class="flex flex-col bg-white shadow rounded-2xl w-full lg:w-1/2 py-10 px-10 mx-auto">
      <div class="pb-10">
        <router-link to="/">
