          ...
          <div class="flex flex-col py-8">
            ...
            <div class="flex flex-col py-4">
              <div class="flex justify-start">
                <a :href="`https://payments.stunning.co/payment_update/3438jgbacfixamwxmcqpdyzbi/${user.stripeId}`" target="_blank">
              ...
              <div class="flex justify-start">
                <a :href="`https://payments.stunning.co/manage_subscription/3438jgbacfixamwxmcqpdyzbi/${user.stripeId}`" target="_blank">
